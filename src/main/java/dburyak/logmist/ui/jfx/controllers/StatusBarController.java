...
public final class StatusBarController {
    ...
    @FXML private ProgressBar mainStatusBarProgressBar;
    @FXML private ProgressBar mainStatusBarHeapBar;
    @FXML private Label mainStatusBarHeapUsed;
    @FXML private Label mainStatusBarHeapAll;
